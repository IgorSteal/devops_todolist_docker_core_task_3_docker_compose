...
DATABASES = {
    'default': {
        ...
        'HOST': os.environ.get('MYSQL_HOST', '172.17.0.2'),  # You can use a different host if your MySQL server is on a remote machine.
        'PORT': os.environ.get('MYSQL_PORT', '3306'), # Leave this empty to use the default MySQL port (3306).
    }
}
